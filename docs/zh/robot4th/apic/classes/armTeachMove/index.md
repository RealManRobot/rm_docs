...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)查阅结构体详细描述。*
*可以跳转[rm_pos_teach_type_e](../../type/index.md#rm_pos_teach_type_e位置示教方向)查阅枚举类型详细描述。*
...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)查阅结构体详细描述。*
*可以跳转[rm-ort-teach-type-e](../../type/index.md#rm_ort_teach_type_e姿态示教方向)查阅枚举类型详细描述。*
...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)和[rm_pos_teach_type_e](../../type/index.md#rm_pos_teach_type_e位置示教方向)查阅结构体详细描述。*
