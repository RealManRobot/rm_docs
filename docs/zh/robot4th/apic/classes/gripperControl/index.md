...
## <div id = '6219'>松开夹爪`rm_set_gripper_release()`</div>
...
## <div id = '6221'>夹爪力控夹取`rm_set_gripper_pick()`</div>
...
## <div id = '6223'>夹爪持续力控夹取`rm_set_gripper_pick_on()`</div>
...
## <div id = '6225'>设置夹爪达到指定位置`rm_set_gripper_position()`</div>
...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)和[rm_gripper_state_t](../../struct/gripperState/index.md)查阅结构体详细描述。*
