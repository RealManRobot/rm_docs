# <p class="hidden">C、C++: </p>运动状态控制指令`armMotionControl`
...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)查阅结构体详细描述。*<br>
*可以跳转[rm_arm_current_trajectory_e](../../type/index.md#rm_arm_current_trajectory_e机械臂当前规划类型)查阅枚举类型详细描述。*
