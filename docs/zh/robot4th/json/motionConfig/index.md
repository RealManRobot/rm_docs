...
可以跳转[current_trajectory_state](#5438)查阅运动到位返回结果输出参数。
...
六自由度机械臂目标关节角度：[1°,0°,20°,30°,0°,20°]，follow表示驱动器的运动跟随效果，true为高跟随，false为低跟随；<br>
...
### <div id = '5438'>轨迹结束返回标志`current_trajectory_state`</div>
