# <p class="hidden">JSON 协议：</p>关节参数指令集
...
反馈关节最小限位，此处以RM65和RM75机械臂为例，详细参数请参考[入门指南 > 参数说明](../../robotParameter/RM65OntologyParameters/index.md)中各系列机械臂的相关参数说明。
...
反馈关节最大限位，此处以RM65和RM75机械臂为例，详细参数请参考[入门指南 > 参数说明](../../robotParameter/RM65OntologyParameters/index.md)中各系列机械臂的相关参数说明。
