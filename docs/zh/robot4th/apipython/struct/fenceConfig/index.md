...
| `cube`    | [rm_fence_config_cube_t](../../struct/fenceConfigCube/index.md), optional | 长方体参数. Defaults to None.     |
| `plane`   | [rm_fence_config_plane_t](../../struct/fenceConfigPlane/index.md), optional  | 点面矢量平面参数。默认为 None。     |
| `sphere`  | [rm_fence_config_sphere_t](../../struct/fenceConfigSphere/index.md), optional  | 球体参数。默认为 None          |
