...
本文主要介绍Microsoft X-Box 360 pad和Logitech Gamepad F710两款手柄的安装方法和按键定义。<br>
...
<table>
  ...
  <tr>
    <td>START键</td>
    <td>短按</td>
    <td colspan="2" style="text-align: center;">2种示教模式切换</td>
  </tr>
  <tr>
    <td>左侧方向键--上</td>
    <td>短按/长按</td>
...
机械臂开启末端通信及供电有多种方式，此处以通过JSON协议的方式设置控制器端RTU通信协议为例。<br>
