...
- 输入参数：
  1. 当前环境的深度图片；
  2. 物体轮廓mask（需要使用其他AI SDK获取，推荐使用睿尔曼[任意物品分割](../itemSegmentation/index.md)、[多模态识别](../multimodalRecognition/index.md)和[任意物品追踪](../itemTracking/index.md)）；
  3. 收集机械臂当前位姿；
