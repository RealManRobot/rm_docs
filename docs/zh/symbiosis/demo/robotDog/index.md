...
|  更新日期  |          更新内容          | 版本号 |
| :--------: | :------------------------: | :----: |
| 2024/11/1 | 复合机器狗项目初始版本发布 | v1.0.0 |
...
本项目主要是睿尔曼的机械臂搭配宇树机器狗的手柄来使用，通过控制器来控制机器狗的站立、趴下、行走（前后、左右和航偏）、姿态（俯仰、倾斜和扭动）和卧倒；同时也可以利用示教模式来控制机械臂的末端位姿、预制位置和灵巧手的开合等，手柄控制说明如下：
...
<video width="300px" autoplay loop muted height="300px" >
  <source src="https://ik.imagekit.io/Realman/Video/%E5%AE%87%E6%A0%91%E6%9C%BA%E5%99%A8%E7%8B%97%E6%9C%BA%E6%A2%B0%E8%87%82%E5%8D%8F%E5%90%8Cnew.mp4?updatedAt=1732866671762" type="video/mp4">
</video>
...
- [睿尔曼机械臂接口函数说明(c++)](../../../robot/apic/getStarted/index.md)
- [睿尔曼机械臂JSON通信协议](../../../robot/json/getStartedJson/index.md)
