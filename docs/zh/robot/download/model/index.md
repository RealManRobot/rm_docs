...
<div class="wrap">
    <div class="d-flex">
        <div class="wrap-item1">
            <h2>ECO63系列</h2>
            <div class="d-flex flex-h-start flex-v-center">
                <p>Github下载： <a href="https://github.com/RealManRobot/rm_models/tree/main/ECO63" target="_blank">ECO63系列（Github）</a></p>
                <p>Gitee下载： <a href="https://gitee.com/RealManRobot/rm_models/tree/main/ECO63" target="_blank">ECO63系列（Gitee）</a></p>
            </div>
        </div>
    </div>
</div>
