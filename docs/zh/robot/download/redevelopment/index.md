...
<h1 class='h1Style'><span style="font-size: 0.6em;">历史版本</span></h1>

<div class="wrap">
    <div class="wrap-item1">
            <p><span style="padding: 2px; font-size: 0.8em; color: #888;">API：<br>API 睿尔曼将继续为您更新维护至2024年年底。2025年后，您可以继续使用API，但睿尔曼将停止维护不再升级，推荐使用 <a href="#00001" target="_blank">API2</a>。</span></p>
            <details>
            <summary><span style="padding: 2px; font-size: 0.8em; color: #888;">点击查看更多</span></summary>
             <p>
            <div class="d-flex flex-h-start flex-v-center">
                <p><span style="padding: 2px; font-size: 0.8em; color: #888;">Github下载： <a href="https://github.com/RealManRobot/RM_API" target="_blank">API（Github）</a></span></p>
                <p><span style="padding: 2px; font-size: 0.8em; color: #888;">Gitee下载： <a href="https://gitee.com/RealManRobot/RM_API" target="_blank">API（Gitee）</a></span></p>
            </div>
            </p>
            </details>
        </div>
