# <p class="hidden">JSON协议：</p>在线编程指令集
...
| 参数 | 类型 | 说明 |
|:------------------|:-------|:----------------------------------------|
|`run_project` | `bool` |`true`：设置成功；`false`：设置失败。 |
...
| 参数 | 类型 | 说明 |
|:------------------|:-------|:----------------------------------------|
|`project_conduct` | `bool` |`true`：接收成功；`false`：接收失败。 |
...
| 参数 | 类型 | 说明 |
|:------------------|:-------|:----------------------------------------|
|`project_state` | `bool` |`true`：设置成功；`false`：设置失败。 |
...
| 参数           | 类型   | 说明                      |
| :------------- | :----- | :------------------------ |
| `popup_result` | `bool` | `true`：继续执行；`false`：停止执行； |
...
### 查询在线编程状态（第三代控制器）`get_program_run_state`
