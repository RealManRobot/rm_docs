...
| 6        | USB接口2      | 作为虚拟网口使用                  |
| 7        | 网口          | 千兆有线网口，通讯网口                        |
| 8        | 状态提示灯    | 根据机械臂不同状态分别显示蓝色、白色、绿色、黄色、红色。<br>①<font color=Blue>蓝色</font>为控制器启动初始化；<br>②白色为各关节启动初始化；<br>③<font color=Green>绿色</font>为机械臂正常运行；<br>④<font color=	#FFA500>黄色</font>为机械臂发出警告信息，为普通故障，需立即处理；<br>⑤<font color=Red>红色</font>为机械臂发生严重故障，需立即处理。 |
...
|<div align="center"> <img src="../operation/image9.png" width = 250 /> </div>|<div align="center"> <img src="../operation/image8.png" width = 250 /> </div>|
|:-:|:-:|
|初代线缆|二代线缆|

16芯连接器的结构示意图如下。

![I/O接口图](../operation/image1.png)
...
![采用内部供电的数字输入](../operation/image2.png)
...
![采用外部供电的数字输出](../operation/image3.png)
...
![通信末端接口](../operation/image4.png)

通信末端接口是一个6芯的连接器，它为连接到机器人的不同夹持器和传感器提供电源和控制信号。

![末端工具接口](../operation/image5.png)
...
| 6    | 轨迹复现按钮（蓝色） | 1路         | 短按，机器人复现拖动示教轨迹 <br> 长按机械臂开始运动到初始位姿，松开停止          |

#### <div id = '33112'>6芯航插线缆</div>

末端工具接口通过1个6芯航插对外连接，航插引脚及定义如下所示。

![工具端航插对外引脚定义](../operation/image6.png)
