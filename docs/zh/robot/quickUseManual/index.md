...
| 2    | 电源接口        | 插入电源线缆。|
| 3    | 复用 IO 接口    | 引出控制器 RS485、I/O 等接口。<br>例如外置急停按钮盒，详细信息请参考[外置急停按钮盒](../../blog/arm/ExternalEmergencyStopButtonBox/index.md)。|
| 4    | 无线网络     | 百兆 Wi-Fi，无线通讯使用。|
...
- WiFi 连接
  ...
  ![alt text](CleanShot2024-08-15at09.50.43@2x.png)
...
这里只是进行简单的示教动作控制，详细的示教器界面的使用参考[睿尔曼机械臂 web 示教器使用](../teachingPendant/armTeching/index.md)，深度的二次开发参考本站开放的接口说明。
