...
|  `custom_config`  |  [`rm_udp_custom_config_t`](../../struct/udpCustomConfig/index.md)  |  自定义上报项。  |
...
|  `custom_config`  |  [`rm_udp_custom_config_t`](../../struct/udpCustomConfig/index.md) , `optional` |  自定义上报项。Defaults to None。  |
