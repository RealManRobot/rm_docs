# <p class="hidden">Python: </p>算法接口配置`algo`
...
*可以跳转[枚举类型说明](../../type/index.md)查阅`rm_robot_arm_model_e`和`rm_force_type_e`枚举详细描述。*
...
## <div id = '6212'>逆解函数`rm_algo_inverse_kinematics()`</div>
...
*可以跳转[rm_inverse_kinematics_params_t](../../struct/inverseKinematicsParams/index.md)、[rm_inverse_kinematics_all_solve_t](../../struct/inverseKinematicsAllSolve/index.md)查阅结构体详细描述。*
...
## <div id = '6272'>从多解中选取最优解（当前仅支持六自由度机器人）`rm_algo_ikine_select_ik_solve()`</div>
...
*可以跳转[rm_inverse_kinematics_all_solve_t](../../struct/inverseKinematicsAllSolve/index.md)查阅结构体详细描述。*
...
## <div id = '6278'>检查逆解结果是否超出关节限位（当前仅支持六自由度机器人）`rm_algo_ikine_check_joint_position_limit()`</div>
...
## <div id = '6280'>检查逆解结果是否超出速度限位（当前仅支持六自由度机器人）`rm_algo_ikine_check_joint_velocity_limit()`</div>
...
## <div id = '6282'>根据参考位形计算臂角大小（仅支持RM75）`rm_algo_calculate_arm_angle_from_config_rm75()`</div>
...
## <div id = '6284'>臂角法求解RM75逆运动学 `rm_algo_inverse_kinematics_rm75_for_arm_angle()`</div>
...
*可以跳转[rm_matrix_t](../../struct/matrix/index.md)查阅结构体详细描述。*
...
## <div id = '6286'>数值法判断机器人是否处于奇异位形 `rm_algo_universal_singularity_analyse()`</div>
...
## <div id = '6288'>解析法判断机器人是否处于奇异位形（仅支持六自由度）`rm_algo_kin_robot_singularity_analyse()`</div>
...
*可以跳转[rm_tool_sphere_t](../../struct/toolToolEnvelope/index.md)查阅结构体详细描述。*
...
## <div id = '6276'>自碰撞检测算法`rm_algo_safety_robot_self_collision_detection()`</div>
