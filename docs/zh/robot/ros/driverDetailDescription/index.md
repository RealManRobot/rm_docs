...
|`pose2`|   `string`   |  位置2关节角度;       |
|`pose3`|   `string`   |  位置3关节角度;       |
|`pose4`|   `string`   |  位置4关节角度;       |
...
| 参数                    | 类型 | 说明                            |
|:----------------------|:---|:------------------------------|
|`mode`|   `uint8`   |  0-电流环模式，<br>1-使用末端六维力，只动位置<br>2-使用末端六维力，只动姿态<br>3-使用末端六维力，位置和姿态同时动       |
...
| 参数                    | 类型 | 说明                            |
|:----------------------|:---|:------------------------------|
|`speed`|   `int16`   |  速度百分比，-100~100：<br>1. speed<0：升降机构向下运动；<br>2. speed>0：升降机构向上运动；<br>3. speed=0：升降机构停止运动。       |
