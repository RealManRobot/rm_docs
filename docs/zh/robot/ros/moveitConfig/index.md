...
```
    ...
    │   │   ├── demo_gazebo.launch            #65仿真机械臂moveit启动文件
    │   │   ├── demo.launch                    #65虚拟机械臂moveit启动文件
    │   │   ├── demo_realrobot.launch           #65真实机械臂moveit启动文件
