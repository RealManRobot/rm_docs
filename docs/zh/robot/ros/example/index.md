...
其中，`<arm_type>`为实际的机械臂型号，支持选择的型号有65、63、eco65、75、gen72。
...
节点启动成功后，需要执行如下指令运行我们更换工具坐标系的节点。
...
```
rosrun rm_demo rm_65_moveit_obstacles_demo.py
```
...
```
rosrun rm_demo rm_65_pick_place_demo
```
