...
本文主要介绍Microsoft X-Box 360 pad手柄的安装方法和按键定义。
...
机械臂开启末端通信及供电有多种方式，此处以JSON协议的方式进行设置。<br>
