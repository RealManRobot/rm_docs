...
可以在ROS中调用API中的算法接口，ROS1参考[调用机械臂JSON协议](../../ros/driverDetailDescription/index.md)；ROS2参考[ROS2调用API接口功能包说明](../../ros2/ros2Description/index.md)。
...
2. 在程序中写入引用的在线编程文件路径（包括文件名），如果为第三代控制器，则该接口支持设置默认在线编程文件以及设置单步模式。如下所示：
