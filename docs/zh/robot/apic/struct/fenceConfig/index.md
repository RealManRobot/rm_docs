...
- ### 长方体参数`cube`
    ...
    *可以跳转[rm_fence_config_cube_t](../../struct/fenceConfigCube/index.md)查阅结构体详细描述。*
...
- ### 点面矢量平面参数`plan`
    ...
    *可以跳转[rm_fence_config_plane_t](../../struct/fenceConfigPlane/index.md)查阅结构体详细描述。*
...
- ### 球体参数`sphere`
    ...
    *可以跳转[rm_fence_config_sphere_t](../../struct/fenceConfigSphere/index.md)查阅结构体详细描述。*
