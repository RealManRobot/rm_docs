...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)和[rm_realtime_push_config_t](../../struct/realtimePushConfig/index.md)查阅结构体详细描述。*
...
*这里使用了机械臂事件回调函数`rm_realtime_arm_state_callback_ptr`。<br>方法原型为：`typedef void(* rm_realtime_arm_state_callback_ptr) (rm_realtime_arm_joint_state_t data)`。<br>跳转[rm_realtime_arm_joint_state_t](../../struct/realtimeArmJointState/index.md)查阅结构体详情。*
