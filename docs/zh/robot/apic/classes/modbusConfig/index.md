...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)和[rm_peripheral_read_write_params_t](../../struct/peripheralReadWriteParams/index.md)查阅结构体详细描述。*
