...
::: warning 注意
设置成功后蜂鸣器响，手动重启控制器进入 WIFISTA  模式。
:::
...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)和[rm_wifi_net_t](../../struct/wifiNet/index.md)查阅结构体详细描述。*
...
::: warning 注意
结构体中的channel值只有在AP模式时才可获取到，标识 wifi 热点的物理信道号。
:::
