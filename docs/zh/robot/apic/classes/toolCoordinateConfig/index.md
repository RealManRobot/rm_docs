# <p class="hidden">C、C++: </p>工具坐标系配置`toolCoordinateConfig`
...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)和[rm_frame_t](../../struct/frame/index.md)查阅结构体详细描述。*
...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)和[rm_frame_name_t](../../struct/frameName/index.md)查阅结构体详细描述。*
...
*可以跳转[rm_robot_handle](../../struct/robotHandle/index.md)和[rm_envelope_balls_list_t](../../struct/envelopeBallsList/index.md)查阅结构体详细描述。*
