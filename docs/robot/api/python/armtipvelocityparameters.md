...
可用于设置、获取机械臂运动参数，可以查阅[ArmTipVelocityParameters继承关系图](../python/InheritanceDiagram/ArmTipVelocityParameters.md)了解与其相关的类的关系。下面是机械臂运动参数`ArmTipVelocityParameters`的详细成员函数说明，包含了方法原型、参数说明、返回值说明和使用示例。
