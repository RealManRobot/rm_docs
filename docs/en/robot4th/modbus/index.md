...
- **Modbus-TCP**: Use the Ethernet port for communication, with parameters set as follows: IP address: IP address of the robotic arm; port number: 502; and device ID: 1.
