...
The RealMan Document Center provides secondary development interface specifications, and secondary development resource downloads based on RealMan robotic arms. This enables developers to fully understand the capabilities of RealMan robotic arms, lower the development threshold, and improve development efficiency. Developers can quickly build robot products for specific application scenarios and conduct in-depth secondary development based on RealMan robotic arms.

## Target user

1. **System integrators & robotic arm application developers:**
   * Provide development interfaces supporting C, C++, Python, Json, and Matlab, meeting the needs of different development environments.
...
3. **Educators:**
   ...
   * Design robotic arm experiment courses based on API interfaces to enable students to master the basic use of standard robotic arms.
...
* The interfaces support multiple development environments, including C, C++, Python, Json, Modbus, and Matlab, fully meeting deployment requirements in any environment by users.
...
* **3D model diagram**
  In STEP format, the 3D model diagram can be downloaded directly and used with common 3D design software such as SolidWorks, UG, Creo, Pro-E, Rhino, and 3Dmax.
* **Simulation model**
  In URDF format, the simulation model can be downloaded directly, supporting the use of Gazebo, Moveit, Webots, Matlab, etc. for robotic arm simulation and development.
* **Robotic arm dimensional drawing**
  The outline dimensions, mounting dimensions of base, and the extended dimensions of the end are accessible for downloading.
* **Software secondary development resource package**
  API interface packages, SDK packages are accessible for downloading. These allow users to conveniently perform secondary development, enabling quick application deployment.

## Contact information and support

1. To learn more about RealMan products, please visit [RealMan official website](https://www.realman-robotics.cn/)
2. To learn more about the use of RealMan products, please visit [RealMan Academy](https://blog.csdn.net/realman_Rop)
3. For any questions about RealMan products, please send an email to the official email account sales@realman-robot.com
4. To learn about the latest news about RealMan products, please follow the WeChat official account
  ![alt text](../../../../zh/robot/summarize/qrcode.jpg)
