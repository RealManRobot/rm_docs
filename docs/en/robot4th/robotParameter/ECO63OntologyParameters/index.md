# <p class="hidden">Ontology Parameters: </p>ECO63 Series Parameters and D-H Model
...
<table>
    ...
    <tr>
        ...
        <td>Standard Version: 9.5<br>Six-Axis Force Version: 9.6</td>
    </tr>
    <tr>
...
### Kinetic parameters of ECO63 robot link

|   joint_id(i)   |  1    |  2    |  3    |  4    |  5    |  6    |  -    |-|
|:--   |:--    |:--    |:--    |:--    |:--    |:--    |:--    |:--|
| **$m$**       | 1.603  | 2.817  | 2.686  | 0.625  | 0.674  | 0.107  | 0.248  |0.189|
| **$x$**       | -12.2| 123.6 | 160.3| 0 | 0 | -0.506 | -0.426 |-0.352|
| **$y$**       | -0.1  | -0.1 | -0.1 | -35.9| 24.6 | 0.255  | 0.237  |-0.067|
| **$z$**       | -34.6| -55.1| 5.4 | 3.7  | -6.6 | -10.801| -27.223|-18.302|
| **$L_{xx}$**  |3922.952|11609.217|3046.210|1358.912|1122.048| 50.918 | 308.844 |133.613|
| **$L_{xy}$**  |-45.663|-17.703| -14.382| -0.068  | -0.008 | -3.136 | -3.781 |0.522|
| **$L_{xz}$**  | -7.247|-22888.890|-5813.379|-0.101|-0.163 | -0.699 | -1.468 |1.623|
| **$L_{yy}$**  |5532.657|111258.158|136090.962|325.708|416.347| 47.420 | 304.616 |130.260|
| **$L_{yz}$**  |-6.022|-13.745|-8.586| -0.699  | -4.733  | 0.388  | 0.888  |0.531|
| **$L_{zz}$**  |2572.738|102697.432|135107.692|1321.875|1025.865| 60.350 | 122.620 |89.503|
| **Remarks**       |         |         |         |         |         | B       | 6F     |6FB|
...
The ECO63-B humanoid robotic arm has six rotating joints, each of which represents one degree of freedom. As shown in the figure below, robot joints include the shoulders (joint 1 and joint 2), elbow (joint 3), and wrists (joint 4, joint 5, and joint 6).

![alt text](../../robotParameter/doc/ECO_63_image1.png)
...
![alt text](../../robotParameter/doc/ECO_63_image2.png)
...
Represent the curves of end load of ECO63-B and ECO63-6F and ECO63-6FB. Where, L refers to the radial distance of the center of mass of end load against the plane of end flange, and Z refers to the normal distance of the center of mass of end load against the plane of end flange.

![ECO65-B](../../robotParameter/doc/ECO_63_image7.png)

<center>End load curves of ECO63-B</center>

![ECO65-6F](../../robotParameter/doc/ECO_63_image8.png)

<center>End load curves of ECO63-6F</center>

![ECO65-6FB](../../robotParameter/doc/ECO_63_imageFB.png)

<center>End load curves of ECO63-6FB</center>
