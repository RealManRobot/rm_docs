# <p class="hidden">JSON protocol</p>Joint configuration instruction set
...
## Set the maximum joint limit (driver)`set_joint_drive_max_pos`
...
1. For the 6-DoF, the minimum positions are as follows: joints 1, 3, and 5: -170°, joints 2, 4, and 6: -110°
2. For the 7-DoF, the minimum positions are as follows: joints 1, 3, 4, and 6: -170°, joints 2, 5, and 7: -110°
