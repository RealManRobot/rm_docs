...
| :--- | :--- | :--- |
|   `handle`  |    Input    |    Robotic arm handle.   |
|   `mode`  |    Input    |    Drag teaching mode <br>0: current loop mode, <br>1: position-only drag in the 6-DoF force mode, <br>2: orientation-only drag in the 6-DoF force mode, <br>3: position-orientation drag in the 6-DoF force mode.   |
|   `singular_wall`  |    Input   |    Available only for the drag teaching in the 6-DoF force mode to enable or disable the drag singular wall. <br>0: disable drag singular wall, <br>1: enable drag singular wall.   |
